...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        #reduce is a function that accepts a function, an iterable and an optional
        #initializer and returns the result of cumulatively applying each element 
        # of the iterable to the given function.
